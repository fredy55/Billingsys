                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input name="ctname" type="text" class="form-control" placeholder="Company Name" required autofocus />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-lg-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input name="cacnum" type="text" class="form-control" placeholder="CAC Number" required />
                                     </div>
                                </div>
